# Sample XGBOOST form Kaggle Titanic Competition (https://www.kaggle.com/c/titanic)
...
print("XGBOOST was succefful and the output was created in data/output/ folder")
